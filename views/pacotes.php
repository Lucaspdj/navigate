...
<div class="internas container clearfix">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<?php
				if($cross1 != null){
					$url = "/pacotes/".$core->normalizaUrl($cross1['secao'])."/".$cross1['id']."-".$core->normalizaUrl($cross1['titulo']);
			?>
			...
			<?php
				...
				if($cross2 != null){
					$url = "/pacotes/".$core->normalizaUrl($cross2['secao'])."/".$cross2['id']."-".$core->normalizaUrl($cross2['titulo']);
			?>
	...
	<div class="col-md-12 destaques" style="margin:0;padding:0">
		<div id="pacotes-abas">
			...
			<?php
				$url = "/pacotes/".$core->normalizaUrl($dados['secao'])."/".$dados['id']."-".$core->normalizaUrl($dados['titulo']);
			?>
